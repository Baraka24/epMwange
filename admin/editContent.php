...
include 'actions/viewContentEdit.php';
...
<div class="container mt-3 ">
  <h2 class="text-center">Editer contenu (<?=$_GET["categorie"]?>) </h2>

  <div class="row col-12 rounded-3 shadow-lg"  id="dropdownMega">
    
  <form action="actions/editContent.php?categorie=<?=$row['categorie']?>" method="POST" enctype="multipart/form-data">
