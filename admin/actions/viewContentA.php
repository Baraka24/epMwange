<?php
$rowsA=mysqli_query($con,"SELECT `contenu`.`id` AS id, `contenu`.`titre` AS titre, 
...
directeur WHERE contenu.directeur=directeur.id AND contenu.categorie='Apropos'");
$rowA=mysqli_fetch_array($rowsA);
?>